...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    public class XRKnob : XRBaseInteractable
    {
        ...
        [SerializeField] private Image steeringWheelIndicator;
        ...
        private void Update()
        {
            if(isGrabbed)
            {
                SetSteeringWheelColorIndicator(Color.green);
            }
            else
            {
                SetSteeringWheelColorIndicator(Color.red);
            }
        }

        public void SetSteeringWheelColorIndicator(Color color)
        {
            steeringWheelIndicator.color = color;
        }
    }
}
